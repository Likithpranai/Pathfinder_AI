...
/**
 * This is a demo page to showcase the Grok AI-powered career recommendations
 * It uses pre-filled sample answers to simulate a completed questionnaire
 */
export default function GrokDemoScreen() {
  ...
  const processAnswers = async () => {
    ...
    try {
      ...
      const response = await getAICareerRecommendations(sampleAnswers, GROK_API_KEY);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Grok AI Career Recommendations</Text>
        <Text style={styles.subtitle}>
          Powered by Grok AI
        </Text>
        <Text style={styles.description}>
          This demo shows how Grok AI analyzes your questionnaire answers and suggests personalized career paths.
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            ...
            <Text style={styles.loadingText}>Analyzing with Grok AI...</Text>
          </View>
        ) : (
