...
export const formatUserAnswersForAI = (selectedOptions: Record<number, string>): string => {
  let prompt = "Based on the following questionnaire responses, suggest the most suitable career fields and specific job roles for this individual:\n\n";
  ...
  prompt += "Please provide a detailed analysis of this person's interests and aptitudes based on their answers. Then recommend 3-5 career fields that would be most suitable for them, along with specific job roles within each field. For each recommendation, include:\n";
